          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md transition-transform duration-300 hover:transform hover:scale-105">
                ...
                <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                  <li className="flex items-center">
                    <i className="fas fa-leaf text-green-500 mr-2"></i> MongoDB
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-elephant text-blue-500 mr-2"></i> PostgreSQL
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-cloud text-indigo-500 mr-2"></i> Supabase
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-bolt text-purple-500 mr-2"></i> Neon
                  </li>
                </ul>
              </div>
